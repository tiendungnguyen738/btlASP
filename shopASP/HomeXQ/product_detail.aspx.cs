...
public partial class Home_product_detail : System.Web.UI.Page
{
    ...
    protected void hienthi()
    {
        ...
        if (pd != null && colors != null)
        {
            ...
            tmp += "<li data-image='images/" + pd.image + "'><img src='images/" + pd.image + "' alt=''></li>";
            tmp += "<li data-image='images/" + pd.image + "'><img src='images/" + pd.image + "' alt=''></li>";
            tmp += "<li data-image='images/" + pd.image + "'><img src='images/" + pd.image + "' alt=''></li>";
            tmp += "</ul>";
            tmp += "</div>";
            ...
            tmp += "<div class='image_selected'><img src='images/" + pd.image + "' alt=''></div>";
            tmp += "</div>";
            tmp += "";
            tmp += "<!-- Description -->";
    ...
    { 
        ...
        for (int i = 0; i < List.Count; i++)
        {
            ...
            tmp += "<div class=\"viewed_image\"><img src=\"images/"+p.image+"\" alt=\"\"></div>";
            tmp += "<div class=\"viewed_content text-center\">";
            tmp += "<div class=\"viewed_price\">" + p.price.ToString("#,##0").Replace(',', '.') + "</div>";
            tmp += "<div class=\"viewed_name\"><a href=\"/shop/Home/product_detail.aspx?product_id="+p.product_id+"\">"+p.product_name+"</a></div>";
            tmp += "</div>";
